...
def analyze_repository(
    ...
    # Odmah prikazuje jasnu gresku ako OpenAI API key nije podesen.
    if not os.getenv("OPENAI_API_KEY"):
        raise RuntimeError(
            "OPENAI_API_KEY is not set. Set it before running the analyzer."
        )

    # LangChain se koristi samo za objasnjenje; GitHub fetching ostaje deterministicki.
    llm = ChatOpenAI(
